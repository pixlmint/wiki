        ...
        <el-form @submit="killSubmit" :model="settings">
            <el-form-item label="Background">
                <el-upload
                    ...
                    action="/api/admin/gallery/upload"
                    :headers="uploadHeaders"
                    :data="{ gallery: currentBoardId }"
                    accept="image/*"
                    v-model:file-list="settings.background"
                >
                    <el-button type="primary">
                        <pm-icon icon="upload" class="me-2"></pm-icon>
                        Click to Upload
                    </el-button>
                    <template #tip> jpg/png files </template>
                </el-upload>
            </el-form-item>
            ...
            <el-form-item label="Labels">
                <labels-editor
                    ...
                    :labels="boardLabels"
                ></labels-editor>
                <el-button v-if="settings.labelsChanged" @click="saveLabels"
...
const onSuccessUploading = function (
