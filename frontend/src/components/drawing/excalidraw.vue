<template>
    ...
    >
        ...
        >
            <MainMenuComponent>
                <el-button @click="exportDrawing()" text
                    ><pm-icon icon="save" /><span>Save</span></el-button
                >
                <el-button @click="excalidrawAPI.refresh()" text
                    ><pm-icon icon="rotate"></pm-icon
                    ><span>Refresh</span></el-button
                >
                <el-button @click="storeLocally()" text
                    ><pm-icon icon="save" /><span>Cache</span></el-button
                >
                <el-button @click="restoreFromLocal" text
                    ><pm-icon icon="upload" /><span>Restore</span></el-button
                >
                <el-button @click="close" text
                    ><pm-icon icon="xmark" /><span>Close</span></el-button
                >
            </MainMenuComponent>
        </ExcalidrawComponent>
    </div>
