...
import MediaModal, { route as mediaRoute } from "@/components/admin/Editor/media/MediaModal.vue";
import JupyterSetupModal, { route as jupyterSetupRoute } from "@/components/jupyter/jupyter-setup-modal.vue";
